\chapter{Framework}
\label{cpt:framework}
\todo{This chapter will cover simulator selection, simulator structure in detail, our implementation and algorithms}
...
\todo{Everything from here on out is the old content that will be rewritten to fit the new structure of this chapter}
