...
\todo{This section should cover results from varying L2 size. Due to the amout of data in this experiment we should aggrigate to keep it readable. See next section for some ideas} 
