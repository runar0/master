...
\footnotetext{Single thread performance is only increased by creating more complex cores; multithreading techniques are required in software to take advantage of \glspl{cmp} performance increase.}
