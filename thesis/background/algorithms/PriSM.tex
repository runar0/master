...
The values of $T_i$ is calculated by Algorithm~\todo{ref}; it is a relatively simple algorithm that will adjust the target occupancy based on current occupancy and the potential for gaining more hits.
