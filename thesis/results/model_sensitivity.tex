...
\begin{figure}[!htb]
        ...
        \end{subfigure}%
        \caption{Core model property sensitivity}\label{fig:results:processor_model}
...
\todo{Could we find a reference stating that this is a bit high?}
...
The observed performance gain when increasing the number of MSHRs in the first level caches, as seen in figure~\ref{fig:results:processor_model:mshr}, is less than 1\% at 50\% storage increase. 
