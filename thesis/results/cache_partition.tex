...
As explained in section~\todo{ref metrics section} STP  is a measure of the overall speedup of all benchmarks in the workload, and a decrease indicates that completing all of them is slower.
...
Section~\todo{ref to benchmarks-workloads} lists each group and explain their specific characteristics.
...
The performance of compute-bound workloads are expected to be mostly unaffected by the partitioning algorithm. 
