...
The increase in both misses and performance for UCP could be an artifact of the lookahead algorithm, as shown in detail in section~\ref{sec:algorithm:ucp}.
