...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.7]{figures/results/speedup/membus-legend-stp-06_4-all-membus}
...
\begin{figure}[t]
    \centering
        \begin{subfigure}[b]{0.5\textwidth}
            \includegraphics[scale=0.8]{figures/results/speedup/membus-legend-0_5M-stp-06_4-ucp-membus}
            \caption{STP.}
