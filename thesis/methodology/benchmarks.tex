...
The both work in a simular manner, by dividing the instruction stream of a benchmark into equal sized intervals. 
...
J. Yi et al.\todo{add cite} has shown that there is little difference between SimPoint and SimFlex selected intervals.
