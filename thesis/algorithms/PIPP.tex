...
PIPP like UCP views the cache set as an gls{lru} stack.
...
In the case where all cores are streaming, and there are no cores to protect, PIPP inserts all blocks at the gls{lru} position.
