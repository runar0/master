...
Figure~\ref{fig:algorithms:lru_example} shows how a 4-way cache set managed by LRU replacement handles four requests. 
...
Then a request for D follows, this is a miss and B is evited.
